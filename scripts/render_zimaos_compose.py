...
Run with: python scripts/render_zimaos_compose.py v0.2.2
...
def render(tag: str) -> str:
    if not re.fullmatch(r"v[0-9]+\.[0-9]+\.[0-9]+", tag):
        raise ValueError("Expected a release tag such as v0.2.2")
    ...
    source["x-casaos"] = {
        ...
        "release_notes": {
            "en_US": "Patch release with aligned version metadata and ZimaOS images.",
            "ja_JP": "バージョン情報とZimaOSイメージ参照を揃えた修正版。",
        },
    }
...
if __name__ == "__main__":
    OUT.write_text(render(sys.argv[1] if len(sys.argv) == 2 else "v0.2.2"))
